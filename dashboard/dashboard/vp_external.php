...
<head>
    ...
    <title>VP-EXTERNAL Candidates - Voting System</title>
...
<body>
    ...
    <div class="container">
        <h1 class="text-center">VP-EXTERNAL</h1>
        
        <div class="row">
        <?php 
        try {
            $query = "SELECT * FROM candidate WHERE position = 'VP-EXTERNAL' AND status = 'approved'";
            $stmt = $conn->prepare($query);
            $stmt->execute();
            ...
            if($stmt->rowCount() > 0) {
                ...
                <div class="alert alert-info text-center">
                    No VP-External candidates found at this time.
                </div>
                <?php
            }
        } catch(PDOException $e) {
        ...
        <div class="footer-links">
            ...
            <a href="vp_external.php" class="active">VP-External</a>
