...
<head>
    ...
    <title>President - PHINMA ONLINE VOTING SYSTEM</title>
...
<body>
    ...
    <div class="container">
        ...
        <?php 
        try {
            $query = "SELECT * FROM candidate WHERE position = 'President' AND status = 'approved'";
            $stmt = $conn->prepare($query);
            $stmt->execute();
            ...
            if($stmt->rowCount() > 0) {
                ...
                <div class="alert alert-info text-center">
                    No presidential candidates found at this time.
                </div>
                <?php
            }
        } catch(PDOException $e) {
        ...
        <div class="footer-links">
            <a href="president.php" class="active">President</a>
